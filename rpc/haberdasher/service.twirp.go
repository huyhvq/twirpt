...
const HaberdasherPathPrefix = "/twirp/huyhvq.twirpt.haberdasher.Haberdasher/"

func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "huyhvq.twirpt.haberdasher")
	...
	switch req.URL.Path {
	case "/twirp/huyhvq.twirpt.haberdasher.Haberdasher/MakeHat":
